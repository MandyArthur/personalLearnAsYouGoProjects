...
var bubbleOptions = {
	...
	timer          : -50,    //The interval time
	tick           : 10,   //The tick speed. The lower this number the faster the bubbles move
	...
	opacityFactor  : 2,     //What Math.random() opacity should be divided by. the lower this number the cleare the bubbles 
	minOpacity     : 0.3,   //The minimum opacity
	ratio          : 45000, //The bubble:pixel ratio (Space between bubbles? )
